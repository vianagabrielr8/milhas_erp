...
      const qty = Math.abs(Number(quantity)); // Garante valor positivo
...
          id="transaction-form"
        >
          {/* CONTA / PROGRAMA - INPUTS PUROS */}
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label htmlFor="accountIdInput">Conta *</Label>
              <Input 
                id="accountIdInput"
                value={accountId}
                onChange={e => setAccountId(e.target.value)}
                placeholder="Digite ID/Nome da Conta"
                required
              />
            </div>
...
              <Input 
                ...
                placeholder="Digite ID/Nome do Programa"
                required
              />
            </div>
          </div>
...
          <Separator />
            ...
            {transactionType === 'VENDA' && (
                <div className="space-y-2">
                    ...
                    {/* Aqui ainda usamos o Select pois é um campo obrigatório para a validação de CPF */}
