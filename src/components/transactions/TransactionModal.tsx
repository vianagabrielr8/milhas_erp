...
              <datalist id="contas-list">
                    {contas?.map(acc => (
                        <option 
                            key={String(acc.id)} 
                            value={String(acc.id)} // ID em string
                            label={acc.name} // Nome exibido na lista (navegadores modernos)
                        >
                            {acc.name} ({String(acc.id)}) 
                        </option>
                    ))}
                </datalist>
            </div>
...
              <datalist id="programas-list">
                    {programas?.map(prog => (
                        <option 
                            key={String(prog.id)} 
                            value={String(prog.id)} // ID em string
                            label={prog.name} // Nome exibido na lista (navegadores modernos)
                        >
                            {prog.name} ({String(prog.id)})
                        </option>
                    ))}
                </datalist>
            </div>
