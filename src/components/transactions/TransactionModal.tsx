...
  AlertTriangle,
  CalendarCheck,
  Loader2, // Adicionado para indicar carregamento
} from 'lucide-react';
...
          {/* CAMPOS DE CONTA E PROGRAMA - Revertido para SELECT do Shadcn/Radix */}
...
          {/* SELETORES DE FORNECEDOR/CLIENTE (PASSAGEIRO) - Revertido para SELECT */}
          {transactionType === 'COMPRA' && (
